              ...
              <div className="relative">
                <select 
                  ...
                  onChange={(e) => {
                    ...
                    if (role === "Admin") setFormData({ email: "mohammedsadiq4850@gmail.com", password: "Password123!" });
                    if (role === "Pricing Manager") setFormData({ email: "pricing@example.com", password: "Password123!" });
                    if (role === "Business Analyst") setFormData({ email: "analyst@example.com", password: "Password123!" });
                    if (role === "Viewer") setFormData({ email: "viewer@example.com", password: "Password123!" });
                    if (role === "") setFormData({ email: "", password: "" });
                  }}
                >
